        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <h2 class="h6 fw-medium fw-medium text-muted mb-0">
                    Welcome <a class="fw-semibold" href="be_pages_generic_profile.html"><?= ucwords(session()->username) ?></a>, everything looks great.
                </h2>
            </div>
                    ...
                    <table class="table table-hover table-vcenter">
                        ...
                        <tbody class="fs-sm">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">21 min ago</td>
                                <td class="d-none d-sm-table-cell text-end">
                                    <strong>$326,91</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
